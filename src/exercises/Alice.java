...
public class Alice {
    public static void main(String[] args) {
        ...
        System.out.println("Enter a term to search within the sentence: ");
        ...
        System.out.println("The index of the search term is "+ sentence.indexOf(term) +" and the length is " +term.length() );
